                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Math.tex('S_{21} = \\frac{-j}{\\sqrt{2}} \\sin(\\theta) \\cdot e^{-j\\theta} = ${controller.s2_mag.toStringAsFixed(4)} \\angle ${_radToDeg(controller.s2_phase).toStringAsFixed(1)}^\\circ', textStyle: const TextStyle(fontSize: 11)),
                        const SizedBox(height: 3),
                        Math.tex('S_{31} = \\frac{-j}{\\sqrt{2}} \\sin(\\theta) \\cdot e^{-j\\theta} = ${controller.s3_mag.toStringAsFixed(4)} \\angle ${_radToDeg(controller.s3_phase).toStringAsFixed(1)}^\\circ', textStyle: const TextStyle(fontSize: 11)),
                        const SizedBox(height: 3),
                        Math.tex('S_{41} = \\cos(\\theta) = ${controller.s4_mag.toStringAsFixed(4)} \\angle ${_radToDeg(controller.s4_phase).toStringAsFixed(1)}^\\circ', textStyle: const TextStyle(fontSize: 11)),
                        const SizedBox(height: 3),
                        Math.tex('S_{11} = \\cos(\\theta) = ${controller.s1_mag.toStringAsFixed(4)} \\angle ${_radToDeg(controller.s1_phase).toStringAsFixed(1)}^\\circ', textStyle: const TextStyle(fontSize: 11)),
                        const SizedBox(height: 8),
                        const Text("Step 2: Convert magnitude to dB using 20×log₁₀(|S|):", style: TextStyle(fontSize: 11, fontWeight: FontWeight.w600)),
                        const SizedBox(height: 4),
                        Math.tex('S_{21} = 20 \\times \\log_{10}(${controller.s2_mag.toStringAsFixed(4)}) = ${s21dB.toStringAsFixed(2)}\\,\\text{dB}', textStyle: const TextStyle(fontSize: 11)),
                        const SizedBox(height: 3),
                        Math.tex('S_{31} = 20 \\times \\log_{10}(${controller.s3_mag.toStringAsFixed(4)}) = ${s31dB.toStringAsFixed(2)}\\,\\text{dB}', textStyle: const TextStyle(fontSize: 11)),
                        const SizedBox(height: 3),
                        Math.tex('S_{41} = 20 \\times \\log_{10}(${controller.s4_mag.toStringAsFixed(4)}) = ${s41dB.toStringAsFixed(2)}\\,\\text{dB}', textStyle: const TextStyle(fontSize: 11)),
                        const SizedBox(height: 3),
                        Math.tex('S_{11} = 20 \\times \\log_{10}(${controller.s1_mag.toStringAsFixed(4)}) = ${s11dB.toStringAsFixed(2)}\\,\\text{dB}', textStyle: const TextStyle(fontSize: 11)),
                      ],
                    ),
                  ),
                  const SizedBox(height: 10),
